  ...
  def cart
    if session[:cart].nil?
     ...
     products.each_with_index do |product, i|
        ...
        current_option = current_product[:options].find { |g| g[:option_id] == o[:option_id] }
        ...
        result[:options].each do |oo|  
        oo['price'] = oo['price'].to_f * oo['count'].to_f
        end
