...
class Admin::OrdersControllerTest < ActionController::TestCase
  ...
  test "should create admin_order" do
    assert_difference('Admin::Order.count') do
      post :create, admin_order: { city: @admin_order.city, description: @admin_order.description, name: @admin_order.name, phone: @admin_order.phone }
    end
  ...
  test "should update admin_order" do
    patch :update, id: @admin_order, admin_order: { city: @admin_order.city, description: @admin_order.description, name: @admin_order.name, phone: @admin_order.phone }
    assert_redirected_to admin_order_path(assigns(:admin_order))
  end
